            ...
            with h5py.File(file_h5) as fh5:
                ...
                for rep in range(reps):
                    ...
                    for ii in range(time):
                        ...
                        mil_scan[i,j,rep,ii] = np.mean(angle)
                    np.save(str(saveLoc)+""+str(saveName)+"_mill6_"+str(paraChange1_name)+"_"+str(paraChange2_name), mil_scan)
